...
function generateTable(data) {
    ...
    for(let i=0; i < NumberOfRows; i++){
        ...
        if(data[i][0] == 'PENTANO'){x[9]=x[9]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'HEXANO'){x[10]=x[10]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'HEPTANO'){x[11]=x[11]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'OCTANO'){x[12]=x[12]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'NONANO'){x[13]=x[13]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'HIDROGENO'){x[15]=x[15]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'OXIGENO'){x[16]=x[16]+parseFloat(data[i][1])}

        //   17 - Carbon monoxide
        if(data[i][0] == 'CO'){x[17]=x[17]+parseFloat(data[i][1])}
        if(data[i][0] == 'CARBON MONOXIDE'){x[17]=x[17]+parseFloat(data[i][1])}
        if(data[i][0] == 'MONOXIDO DE CARBONO'){x[17]=x[17]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'AGUA'){x[18]=x[18]+parseFloat(data[i][1])}
        ...
        if(data[i][0] == 'SULFURO DE HIDROGENO'){x[19]=x[19]+parseFloat(data[i][1])}

        //   20 - Helium
        if(data[i][0] == 'HE'){x[20]=x[20]+parseFloat(data[i][1])}
        if(data[i][0] == 'HELIUM'){x[20]=x[20]+parseFloat(data[i][1])}
        if(data[i][0] == 'HELIO'){x[20]=x[20]+parseFloat(data[i][1])}
    ...
    if (SumOfComponents > 0.001){
        for(let i=1; i <= 21; i++){
            x[i]=x[i]/SumOfComponents;
        }
        FromXToDOMs();
        webButtons[3].activateMe();
    }
